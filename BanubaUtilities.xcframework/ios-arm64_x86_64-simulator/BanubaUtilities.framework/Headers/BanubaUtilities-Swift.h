...
SWIFT_CLASS("_TtC15BanubaUtilities35GalleryHeaderCollectionReusableView")
...
SWIFT_CLASS("_TtC15BanubaUtilities22GalleryItemPreviewView")
@interface GalleryItemPreviewView : UIViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@interface GalleryItemPreviewView (SWIFT_EXTENSION(BanubaUtilities)) <AppStateObserverDelegate>
- (void)applicationDidBecomeActive:(AppStateObserver * _Nonnull)appStateObserver;
- (void)applicationWillResignActive:(AppStateObserver * _Nonnull)appStateObserver;
- (void)applicationWillEnterForeground:(AppStateObserver * _Nonnull)appStateObserver;
@end
...
typedef SWIFT_ENUM(NSInteger, GalleryMediaType, open) {
  ...
  GalleryMediaTypeGeneratedAIVideo = 3,
};
...
- (void)galleryViewControllerDidRequestGenAIVideo:(GalleryViewController * _Nonnull)controller;
@end
...
SWIFT_CLASS("_TtC15BanubaUtilities13VoiceRecorder")
